...
<head>
	...
	$(function(){
		$("#AddQuantityBtn").on('click', function(){
			$("#addQuantityForm").toggle(1500);
		});
		
	});
	
	function showEditProductForm(empid) {
		alert(empid);
		$("#EditProductForm_" + empid).toggle(1000);
	}
	</script>
            	...
            	<td colspan="6">
                	<table width="100%">
                    	<tr>
                            ...
                            <td width="10%"><button class="DeleteProductBtn" ng-click="deleteData(product.id)">Delete</button></td>
                        </tr>
                    </table>
                </td>
            </tr>
